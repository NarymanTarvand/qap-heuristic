...
from global_calculations import calculate_objective, calculate_objective_incremental
...
def calculate_neighbourhood_improving_similar(
    neighbourhood: list, flow: np.array, distance, local_optima: list, current_obj: int
) -> tuple[list, float]:
